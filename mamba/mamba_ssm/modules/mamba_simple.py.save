...
class Mamba(nn.Module):
    ...
    def forward(self, hidden_states, inference_params=None, T=1):
        ...
        # print(f"hidden_states size: {hidden_states.shape}")
        ...
        if self.use_fast_path and inference_params is None:  # Doesn't support outputting the states
            if self.bimamba:
                ...
                # print(f"out size (bimamba): {out.shape}")
            else:
                out = mamba_inner_fn(
                    xz,
                    self.conv1d.weight,
            ...
            # print(f"x size: {x.shape}, z size: {z.shape}")
            ...
            # print(f"x after conv1d size: {x.shape}")
            ...
            # print(f"dt size: {dt.shape}, B size: {B.shape}, C size: {C.shape}")
            ...
            out = self.out_proj(y)
            # print(f"out size (final): {out.shape}")
        return out
